...
public final class Constants {
        ...
        public static final double MOVEMENT_SPEED_DIVISOR = 1.0;
        ...
        /**
         * The position in degrees from the starting position that the arm should go to
         * for picking
         * up objects
         */
        ...
        public static final Gains PRACTICE_BALANCING_GAINS = new Gains(.0205, 0.00001, 0.0, 0.0, 0, .75);
        public static final Gains BUMPERLESS_ROBOT_GAINS = new Gains(0.75, 0, 0, 0, 0, 1);
        public static final Gains WITH_BUMPER_ROBOT_GAINS = new Gains(0.35, 0.00001, 100, 0.2, 0, 1.0);
        public static final Gains BUMPERLESS_ROTATION_GAINS = new Gains(0.004, 0.003, 0.001, 0.0, 0, 0.0);
        public static final Gains WITH_BUMPER_ROTATION_GAINS = new Gains(0.06, 0.003, 0.001, 0.0, 0, 0.0);
